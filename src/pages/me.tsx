                                    ...
                                    <Modal title="Join the Discord" isOpen={showModal} onClose={() => setShowModal(false)}>
                                        ...
                                        <p onClick={() => !waiting && joinDiscord()}>
                                            <div className="flex flex-row items-center space-x-2 mt-2">
                                                <span className={`w-32 justify-center px-2 py-1 text-white flex items-center space-x-2 rounded-md transition-all duration-200 ${waiting ? "bg-slate-200" : "bg-[#5865F2] cursor-pointer"}`}>
                                                    <BsDiscord />

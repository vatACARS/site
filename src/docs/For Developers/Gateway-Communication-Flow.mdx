...
<div className="mt-3">
  ...
  <TabPanel
    id="tabs-basic-3"
    labelledById="tabs-basic-item-3"
  >
    <p className="text-base-content/80">
      <span className="text-base-content/90 font-semibold">Messages:</span> View your recent messages, chat with friends, and manage your conversations.
    </p>
  </TabPanel>
</div>